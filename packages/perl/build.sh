...
termux_step_post_make_install () {
	...
	sed 's',"--sysroot=$TERMUX_STANDALONE_TOOLCHAIN"/sysroot,"-I/data/data/pl.sviete.dom/files/usr/include",'g' Config_heavy.pl > Config_heavy.pl.new
	sed 's',"$TERMUX_STANDALONE_TOOLCHAIN"/sysroot,"-I/data/data/pl.sviete.dom/files",'g' Config_heavy.pl.new > Config_heavy.pl
