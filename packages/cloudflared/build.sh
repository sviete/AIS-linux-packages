...
termux_step_make_install() {
	...
	mkdir /data/data/pl.sviete.dom/files/home/.cloudflared
	curl -L --url https://ai-speaker.com/ota/ais_cloudflared --output /data/data/pl.sviete.dom/files/home/.cloudflared/cert.pem
}
