...
TERMUX_PKG_SHA256=134e5751cf62fa189f76616a698ce0df4b4a0c1419ec0b582924087e585f66b3
...
termux_step_make() {
	...
	find -name "stdlib_osproc.nim.c" | xargs -n 1 sed -i 's',"/system/bin/sh\"\,\ 14","/data/data/pl.sviete.dom/files/usr/bin/sh\"\,\ 38",'g'
